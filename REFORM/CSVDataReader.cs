...
namespace REFORM
{
    ...
    public class CsvDataReader : IDataReader
    {
        ...
        /// <returns></returns>
        virtual public object this[int i]
        {
            get
            {
                return csv[i];
        ...
        /// </summary>
        virtual public bool IsClosed { get; private set; }

        /// <summary>
        /// Gets the number of rows changed, inserted, or deleted by execution of the SQL statement.
        /// </summary>
        virtual public int RecordsAffected
        {
            get
            {
                return 0;
        ...
        /// </returns>
        virtual public bool GetBoolean(int i)
        {
        ...
        /// </returns>
        virtual public byte GetByte(int i)
        {
        ...
        /// </returns>
        virtual public long GetBytes(int i, long fieldOffset, byte[] buffer, int bufferoffset, int length)
        {
        ...
        /// </returns>
        virtual public char GetChar(int i)
        {
        ...
        /// </returns>
        virtual public long GetChars(int i, long fieldoffset, char[] buffer, int bufferoffset, int length)
        {
        ...
        /// </returns>
        virtual public IDataReader GetData(int i)
        {
            return null;
        }
        ...
        /// </returns>
        virtual public string GetDataTypeName(int i)
        {
        ...
        /// </returns>
        virtual public DateTime GetDateTime(int i)
        {
        ...
        /// </returns>
        virtual public double GetDouble(int i)
        {
        ...
        /// </returns>
        virtual public float GetFloat(int i)
        {
        ...
        /// </returns>
        virtual public Guid GetGuid(int i)
        {
        ...
        /// </returns>
        virtual public short GetInt16(int i)
        {
        ...
        /// </returns>
        virtual public int GetInt32(int i)
        {
        ...
        /// </returns>
        virtual public long GetInt64(int i)
        {
        ...
        /// </returns>
        virtual public string GetName(int i)
        {
        ...
        /// </returns>
        virtual public int GetOrdinal(string name)
        {
        ...
        /// </returns>
        virtual public string GetString(int i)
        {
        ...
        /// </returns>
        virtual public object GetValue(int i)
        {
        ...
        /// </returns>
        virtual public int GetValues(object[] values)
        {
        ...
        /// </returns>
        virtual public bool IsDBNull(int i)
        {
        ...
        /// </returns>
        virtual public bool NextResult()
        {
            return false;
        }
